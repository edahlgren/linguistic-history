...
d3.json("data/middle.json").then(function(genealogy) {
    ...
    // Connect Mathesius
    connect_vertical(svg, "Mathesius-Marty", dark_green, {
        start: mathesius_bottom[0],
        end: marty_left[0]
    });    
    connect_vertical(svg, "Mathesius-Masaryk", dark_green, {
    ...
    connect_vertical(svg, "Brentano-Masaryk", dark_green, {
    ...
    connect_vertical(svg, "Brentano-Freud", dark_green, {
    ...
    connect_vertical(svg, "Brentano-Stumpf", dark_green, {
    ...
    // Connect Gestalt
    connect_vertical(svg, "Langfeld-Stumpf", dark_green, {
        start: langfeld_left[0],
        end: stumpf_right[0]
    });
    connect_vertical(svg, "Wertheimer-Stumpf", dark_green, {
        start: wertheimer_left[0],
        end: stumpf_right[1]
    });
    connect_vertical(svg, "Heider-Wertheimer", dark_green, {
    ...
    connect_vertical_dotted(svg, "Hilbert-Husserl", dark_green, {
